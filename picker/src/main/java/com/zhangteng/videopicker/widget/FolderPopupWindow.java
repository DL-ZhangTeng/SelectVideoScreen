...
public class FolderPopupWindow extends PopupWindow {
    ...
    public FolderPopupWindow(Context context, FolderListAdapter folderListAdapter) {
        ...
        popupWindow = inflater.inflate(R.layout.video_picker_popup_folder, null);
        initView();
        init();
    ...
    private void initView() {
        recyclerView = (RecyclerView) popupWindow.findViewById(R.id.video_picker_rv_folder_list);
    ...
    private void init() {
        ...
        ColorDrawable dw = new ColorDrawable(mContext.getResources().getColor(R.color.video_picker_folder_bg));
